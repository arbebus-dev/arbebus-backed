...
const STORAGE_KEYS = {
  ...
  userLoggedIn: "arbebus_user_logged_in",
  loginProvider: "arbebus_login_provider",
};
...
export default function MenuScreen() {
  ...
  const [userName, setUserName] = useState("Edgaras");
  const [userEmail, setUserEmail] = useState("guest@arbebus.app");
  const [isLoggedIn, setIsLoggedIn] = useState(false);
  const [loginProvider, setLoginProvider] = useState("Guest");
    ...
    const loadSaved = async () => {
      try {
        const [
          ...
          AsyncStorage.getItem(STORAGE_KEYS.userLoggedIn),
          AsyncStorage.getItem(STORAGE_KEYS.loginProvider),
        ]);
        ...
        if (savedProvider) setLoginProvider(savedProvider);
      } catch (error) {
            ...
            <View style={styles.profileTopRow}>
              ...
              <View style={styles.profileTextWrap}>
                ...
                <Text style={styles.profileSubline}>
                  {isLoggedIn
                    ? `Prisijungta per ${loginProvider}`
                    : "Vienas app visam judėjimui mieste"}
                </Text>
              </View>
            </View>
