...
module.exports = {
  env: {
    ...
    OPENCAGE_API_KEY:
      process.env.OPENCAGE_API_KEY || process.env.OPEN_CAGE_API_KEY || "",
    ...
    DEFAULT_ORIGIN_STOP_RADIUS_METERS: readNumber(
      "DEFAULT_ORIGIN_STOP_RADIUS_METERS",
      700,
    ),
    DEFAULT_DESTINATION_STOP_RADIUS_METERS: readNumber(
      "DEFAULT_DESTINATION_STOP_RADIUS_METERS",
      700,
    ),
    ...
    LEAVE_ALERT_ENGINE_INTERVAL_MS: readNumber(
      "LEAVE_ALERT_ENGINE_INTERVAL_MS",
      10000,
    ),
