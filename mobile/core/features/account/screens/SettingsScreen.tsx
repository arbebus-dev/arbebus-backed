  ...
  const enableNotifications = async (value: boolean) => {
    ...
    if (!granted) {
      Alert.alert(
        ...
        t.account.settings.notificationsPermissionDenied,
      );
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Section title={t.account.settings.sectionApp} />
        ...
        <AccountCard>
          ...
          <ChoiceRow
            title={t.account.settings.theme}
            value={preferences.themeMode}
            options={[
              { label: t.account.settings.themeDark, value: "dark" },
              { label: t.account.settings.themeLight, value: "light" },
            ]}
            onChange={(value) => setThemeMode(value)}
          />

          <AccountListItem
            title={t.account.settings.notificationSound}
            value={
              preferences.notificationSound === "arbebus"
                ? t.account.settings.notificationSoundArbebus
                : t.account.settings.notificationSoundDefault
            }
            subtitle={t.account.settings.notificationSoundHint}
        ...
        <Section title={t.account.settings.sectionNotifications} />

        <AccountCard>
          <SettingsToggle
            title={t.account.settings.notifications}
            subtitle={t.account.settings.notificationsSubtitle}
            value={preferences.notificationsEnabled}
            onValueChange={enableNotifications}
          />

          <SettingsToggle
            title={t.account.settings.tripAlerts}
            value={preferences.tripAlerts}
            onValueChange={(value) => setPreference("tripAlerts", value)}
          />

          <SettingsToggle
            title={t.account.settings.delayAlerts}
            value={preferences.delayAlerts}
            onValueChange={(value) => setPreference("delayAlerts", value)}
          />

          <SettingsToggle
            title={t.account.settings.reminders}
            value={preferences.leaveReminders}
            onValueChange={(value) => setPreference("leaveReminders", value)}
          />

          <SettingsToggle
            title={t.account.settings.paymentNotifications}
            value={preferences.paymentNotifications}
            onValueChange={(value) =>
              setPreference("paymentNotifications", value)
            }
            isLast
          />
        </AccountCard>

        <Section title={t.account.settings.sectionPayments} />

        <AccountCard>
          <SettingsToggle
            title={t.account.settings.autoPayments}
            subtitle={t.account.settings.autoPaymentsSubtitle}
        ...
        <Section title={t.account.settings.sectionOther} />

        <AccountCard>
          <AccountListItem
            title={t.account.settings.aboutApp}
            value="1.0.1"
