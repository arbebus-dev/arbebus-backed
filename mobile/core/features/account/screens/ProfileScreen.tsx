...
export default function ProfileScreen({ onBack }: Props) {
  ...
  >(
    () => [
      {
        key: "firstName",
        title: t.account.profile.firstName,
        placeholder: t.account.profile.firstNamePlaceholder,
      },
      {
        key: "lastName",
        title: t.account.profile.lastName,
      ...
      {
        key: "city",
        title: t.account.profile.city,
        placeholder: t.account.profile.cityPlaceholder,
      },
      {
        key: "country",
        title: t.account.profile.country,
        placeholder: t.account.profile.countryPlaceholder,
      },
      {
        key: "birthDate",
        title: t.account.profile.birthDate,
        placeholder: t.account.profile.birthDatePlaceholder,
      },
      {
        key: "avatarUri",
        title: t.account.profile.avatarUri,
        placeholder: t.account.profile.avatarUriPlaceholder,
      },
    ],
    [t],
  );
  ...
  const activeField = useMemo(
    () => fields.find((field) => field.key === editingKey) || null,
    [editingKey, fields],
  );
  ...
  const readyProfile = profile || {
    ...
    city: t.account.profile.cityPlaceholder,
    country: t.account.profile.countryPlaceholder,
  };
  ...
  return (
    ...
    >
      ...
      >
          ...
          style={[
            styles.glow,
            {
              backgroundColor: theme.isLight
                ? "rgba(55,245,174,0.20)"
                : "rgba(55,245,174,0.08)",
            },
          ]}
        />
        ...
        <Section title={t.account.profile.sectionPersonal} />
        <AccountCard>
          {fields.map((field, index) => (
            <AccountListItem
              ...
              title={field.title}
              value={
                readyProfile[field.key] || t.account.profile.profileEmptyValue
              }
        ...
        <Section title={t.account.profile.sectionPro} />
        <AccountCard>
          <AccountListItem
            title={t.account.profile.proTitle}
            subtitle={t.account.profile.proSubtitle}
            icon="crown-outline"
            onPress={() =>
              Alert.alert(
                t.account.profile.proAlertTitle,
                t.account.profile.proAlertMessage,
              )
            }
            isLast
          />
